...
\begin{lem}
The map $J$ is a cochain map.
Furthermore, for any $a,a' \in \sfA$ we have $\{J_a, J_{a'}\} = 0$.
Thus, if we endow $\sfA$ with the structure of an abelian dg Lie algebra then $J$ is a map of dg Lie algebras.
\end{lem}
\begin{proof}
