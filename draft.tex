...
Following up (cf. his thesis \cite{Wthesis} and its offshoot \cite{Wrenorm}), Williams laid a systematic mathematical foundations:
\begin{itemize}
...
(Similar results hold for topological-holomorphic theories~\cite{WWthf}.)
