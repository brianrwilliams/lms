...
and Costello advocated it for holomorphic twists, particularly in the setting of holography \cite{}.
...
This locus determines the GIT quotients and hence explains the isomorphism we saw on the moduli spaces.
...
The isomorphism of moduli spaces ensures that there is a dual vacuum $x_D$ to $x$ in the dual theory, and its perturbative theory is equivalent to the perturbative theory for $x$,
...
\begin{prop}
The isomorphism between the semi-stable locus of the two moduli stacks determines an isomorphism between quantizations over those loci.
\end{prop}
...
\begin{dfn}
For a holomorphic QCD theory let $\cM^q_{\rm vac}(F,N)$ denote the stack $\cM_{\rm vac}(F,N)$ equipped with a sheaf of factorization algebras on $\CC^2$.
The value at a solution $x$ is a quantization of the observables for the classical perturbative theory labeled by~$x$.
(One could focus, for simplicity, on the sheaf of polydiscs algebras.)
