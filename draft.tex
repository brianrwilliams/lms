...
\begin{lem}
For a holomorphic QCD theory $\cT(F,N)$, this compactification is a Landau-Ginzburg B-model~$\cT(F,N)_2$.
\owen{Not sure what's the best way to characterize which one we get.}
\end{lem}
