...
For a systematic introduction to classical field theory in a style amenable to a complex geometer,
we suggest \cite{FreedDeligne},
although there are many other sources, such as \cite{}.
For a detailed development of field theory in dialogue with derived geometry,
see \cite{Steffens},
and for a motivational discussion, likely more accessible to physicists, see \cite{AlfonsoYoung?}.
...
close to the style we used for holomorphic Chern-Simons theory.
...
\owen{Somewhere cite Donaldson and Thomas.}
