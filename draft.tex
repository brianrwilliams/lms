...
In derived geoemtry one can take a ``shifted cotangent bundle'' $T^*[-1] \RR\Hol(X,V)$,
...
So far, most mathematical effort in this direction has focused on classical aspects of gauge theory,
...
interface with complex geometry in general and with mathematical methods of rather recent vintage,
