...
(For algebraic geometers consider \cite{Toen,PridEug}; for symplectic or Poisson geometers consider \cite{PTVV, Safronov}; for differential geometers consider \cite{Joyce}; and for representation theorists consider \cite{BZNad, GaiRoz, Raskin}.)
