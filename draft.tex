...
This local Lie algebra is a classical symmetry of the holomorphic QCD theory (in particular, the holomorphic twist of any four-dimensional supersymmetric QCD). 
\end{thm}
...
Naively, the field $Q = z_1^n z_2^m \otimes v$ transforms like $\Delta^{hol}(Q) = (n+m) Q$;
...
\]
and similarly for the antiquarks ${Q}^\dag$ and~${P}^\dag$. 
...
\[
 \frac{F - 3N}{2} \int \partial_{z_i} X_i \op{Tr} (\partial A \, \partial A)  .
\]
...
\brian{
I'm not sure how to interpret this, so we may want to leave it out. 
The thing I don't understand is what we can glean about `scale' at the level of the holomorphic twist. 
I was hopeful about this computation since it's curious that this anomaly vanishes precisely at the upper bound of the `conformal window', but I'm not sure how to see the full window at the level of the twist. 
Any thoughts?
}
...
Consider any semistable point $x$ in $[V/G]s$.
