...
For a smooth $n$-manifold $M$, one cover is simply to take the collection of open sets in $M$ diffeomorphic to a disjoint union of finitely many copies of the open $n$-disc.
...
\end{quote}
To physicists, this claim should not be so surprising, upon some reflection:
the Weiss cosheaf gluing axiom offers a precise version of the idea that a quantum field theory can be fully encoded by all its $n$-point functions.
