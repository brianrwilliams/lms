...
\begin{center}
  \begin{tikzpicture}
   ...
   \draw[semithick] (0,0) circle (0.75);
   \draw[semithick] (1,1) circle (0.5);
   \fill (0,0) circle (0.05) node [below right] {$0$};
   \fill (1,1) circle (0.05) node [below right] {$p$};
\end{tikzpicture}
\end{center}
where there is a disc centered at the origin with larger radius and a disc centered at a point~$p$ with smaller radius.
...
with a view towards motivating the relationship to vertex algebras.
