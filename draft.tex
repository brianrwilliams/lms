...
As an example, four-dimensional minimally supersymmetric Yang-Mills theory admits no topological twist, but does admit a twist to a holomorphic field theory whose moduli space is described, in part, by $\RR \Bun_G(X)$. 
