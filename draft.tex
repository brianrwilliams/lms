...
The fields of the theory consist of a pair $(\gamma,\beta)$ where 
\[
...
\]
We again suggest to identify solutions to the equation $\dbar \beta = 0$ that differ by a $\dbar$-exact form.

We will not examine fermions here,
but note that it is straightforward to consider super-holomorphic vector bundles,
i.e., holomorphic $\ZZ/2$-graded vector bundles.
In this way, one can develop analogs of fermions.

\subsubsection{Holomorphic $\sigma$-models}

\owen{Quickly explain the nonlinear analog of the $\beta\gamma$ system.}
