...
In physics, the relationship between the Weyl algebra on generators $p, q$ and its loopy version $W[V]$ is by a process called {\it dimensional reduction}.
...
We can extract from $L_{2d}$ a Lagrangian on a one-dimensional space by the process of {\it compactification}. 
...
\beqn
L_{1d}\left( \ldots, \phi_{-1}, \phi_0 , \phi_1, \ldots \right) = \sum_{k\in \ZZ} \phi_{-k} \,\d \phi_{k} + k\, \phi_k \, \phi_{-k} \, \d t .
\eeqn 
