...
\begin{itemize}
\item The pure gauge anomaly: it is proportional to the representation-theoretic factor $\op{Tr}_{ad}(X^3)$, $X \in \lie{g}$.
...
and it is proportional to the representation-theoretic factor $\op{Tr}_V(X^3)$, $X \in \lie{g}$.
\end{itemize}
