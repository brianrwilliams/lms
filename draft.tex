...
\begin{prop}
The central extensions of the dual theories agree: 
\[
\theta_\sfE = \theta_\sfM.
\] 
...
The central extension is represented by a series of Feynman diagrams that are wheels with three vertices, each labeled by an element $\sfa$ of the current algebra, which we treat as a background gauge field.
...
N \frac16 \int \op{tr}_{\underline{F}} \left(\sfa \partial \sfa \partial \sfa\right) 
\eeqn
...
\[
\check{N} \frac16 \int \op{tr}_{\Bar{\underline{F}}} \left(\sfa \partial \sfa \partial \sfa\right) .
\]
\owen{Continue from here}
